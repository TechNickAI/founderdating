...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FdProfile.building_blurb'
        db.add_column('profiles_fdprofile', 'building_blurb', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FdProfile.building_blurb'
        db.delete_column('profiles_fdprofile', 'building_blurb')
