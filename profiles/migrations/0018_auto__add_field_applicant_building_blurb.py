...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Applicant.building_blurb'
        db.add_column('profiles_applicant', 'building_blurb', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Applicant.building_blurb'
        db.delete_column('profiles_applicant', 'building_blurb')
