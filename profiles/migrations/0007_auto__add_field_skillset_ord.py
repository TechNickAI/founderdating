...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Skillset.ord'
        db.add_column('profiles_skillset', 'ord', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Skillset.ord'
        db.delete_column('profiles_skillset', 'ord')
