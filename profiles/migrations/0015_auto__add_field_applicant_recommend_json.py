...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Applicant.recommend_json'
        db.add_column('profiles_applicant', 'recommend_json', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Applicant.recommend_json'
        db.delete_column('profiles_applicant', 'recommend_json')
    ...
    models = {
        ...
        'profiles.applicant': {
            ...
            'recommend_json': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
