...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FdProfile.comments'
        db.add_column('profiles_fdprofile', 'comments', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Applicant.comments'
        db.add_column('profiles_applicant', 'comments', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FdProfile.comments'
        db.delete_column('profiles_fdprofile', 'comments')

        # Deleting field 'Applicant.comments'
        db.delete_column('profiles_applicant', 'comments')
