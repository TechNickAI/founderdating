...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LinkedinProfile.connections_raw'
        db.add_column('profiles_linkedinprofile', 'connections_raw', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LinkedinProfile.connections_raw'
        db.delete_column('profiles_linkedinprofile', 'connections_raw')
