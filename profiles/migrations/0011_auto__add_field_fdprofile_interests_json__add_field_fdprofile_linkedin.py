...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FdProfile.interests_json'
        db.add_column('profiles_fdprofile', 'interests_json', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'FdProfile.linkedin_url'
        db.add_column('profiles_fdprofile', 'linkedin_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FdProfile.interests_json'
        db.delete_column('profiles_fdprofile', 'interests_json')

        # Deleting field 'FdProfile.linkedin_url'
        db.delete_column('profiles_fdprofile', 'linkedin_url')
    ...
    models = {
        ...
        'profiles.fdprofile': {
            ...
            'interests_json': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
