...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FdProfile.founder_type'
        db.add_column('profiles_fdprofile', 'founder_type', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True), keep_default=False)

        # Adding field 'Applicant.founder_type'
        db.add_column('profiles_applicant', 'founder_type', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True), keep_default=False)

        # Adding field 'Applicant.event_group'
        db.add_column('profiles_applicant', 'event_group', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FdProfile.founder_type'
        db.delete_column('profiles_fdprofile', 'founder_type')

        # Deleting field 'Applicant.founder_type'
        db.delete_column('profiles_applicant', 'founder_type')

        # Deleting field 'Applicant.event_group'
        db.delete_column('profiles_applicant', 'event_group')
