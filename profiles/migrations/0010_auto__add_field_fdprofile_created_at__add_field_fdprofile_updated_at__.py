...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FdProfile.created_at'
        db.add_column('profiles_fdprofile', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2011, 5, 1), blank=True), keep_default=False)

        # Adding field 'FdProfile.updated_at'
        db.add_column('profiles_fdprofile', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=datetime.date(2011, 5, 1), blank=True), keep_default=False)

        # Adding field 'LinkedinProfile.created_at'
        db.add_column('profiles_linkedinprofile', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2011, 5, 1), blank=True), keep_default=False)

        # Adding field 'LinkedinProfile.updated_at'
        db.add_column('profiles_linkedinprofile', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=datetime.date(2011, 5, 1), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FdProfile.created_at'
        db.delete_column('profiles_fdprofile', 'created_at')

        # Deleting field 'FdProfile.updated_at'
        db.delete_column('profiles_fdprofile', 'updated_at')

        # Deleting field 'LinkedinProfile.created_at'
        db.delete_column('profiles_linkedinprofile', 'created_at')

        # Deleting field 'LinkedinProfile.updated_at'
        db.delete_column('profiles_linkedinprofile', 'updated_at')
