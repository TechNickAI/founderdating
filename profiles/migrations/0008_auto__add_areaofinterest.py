...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AreaOfInterest'
        db.create_table('profiles_areaofinterest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('ord', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal('profiles', ['AreaOfInterest'])


    def backwards(self, orm):
        
        # Deleting model 'AreaOfInterest'
        db.delete_table('profiles_areaofinterest')
    ...
    models = {
        ...
        'profiles.areaofinterest': {
            'Meta': {'object_name': 'AreaOfInterest'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
