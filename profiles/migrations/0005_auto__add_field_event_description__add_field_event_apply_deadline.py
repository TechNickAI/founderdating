...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profiles_event', 'description', self.gf('django.db.models.fields.TextField')(default='', max_length=1000), keep_default=False)

        # Adding field 'Event.apply_deadline'
        db.add_column('profiles_event', 'apply_deadline', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 4, 25)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.description'
        db.delete_column('profiles_event', 'description')

        # Deleting field 'Event.apply_deadline'
        db.delete_column('profiles_event', 'apply_deadline')
